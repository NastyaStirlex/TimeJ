...
import com.example.timej.navigation.StudentNavBar
import com.example.timej.navigation.TeacherNavBar
...
import com.example.timej.ui.screen.shedule.ScheduleScreen
...
fun Navigation(
    ...
    NavHost(
        ...
        composable(
            route = "shedule?group={group}&teacher={teacher}&building={building}&auditorium={auditorium}",
            arguments = listOf(
                navArgument("group") {
                    nullable = true
                    defaultValue = null
